...
<div class="boxed">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                    <h1 class="title">الأستشارات الهندسية</h1>
            </div><!-- /.col-md-12 -->
        </div><!-- /.row -->
    </div><!-- /.container -->
</div><!-- /.page-title -->
                ...
                <div class="right-box">
                    <div class="single-sidebar-widget">
                        <div class="single-service-list-widget">
                            <ul class="">
                                <li class="active"><a data-toggle="tab" href="#home">استشاره 1</a></li>
                                <li><a data-toggle="tab" href="#menu1">استشاره 2</a></li>
                                <li><a data-toggle="tab" href="#menu2">استشاره 3</a></li>
                                <li><a data-toggle="tab" href="#menu3">استشاره 4</a></li>
                                <li><a data-toggle="tab" href="#menu4">استشاره 5</a></li>
                                <li><a data-toggle="tab" href="#menu5">استشاره 6</a></li>
                                <li><a data-toggle="tab" href="#menu6">استشاره 7</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
